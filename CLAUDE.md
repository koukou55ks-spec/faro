...
**サービス名:** Faro（スペイン語で「灯台」の意味）
灯台は、船が荒波を安全に航海できるよう周りを明るく照らす。Faroは、より多くの人々にとって、人生の金融航海における灯台のような存在でありたい。

**ミッション:** 「人類の金融ウェルビーイングを向上させる」
**ビジョン:** 「一生涯の金融思考パートナー」
...
1. **Context is everything** - コンテキストがすべて。パーソナライゼーションを最優先
2. **Intelligence, not automation** - 効率化ではなく思考拡張。従来の金融アプリとの差別化
3. **Accessible excellence** - 卓越性を万人に。専門家レベルの金融アドバイスを民主化
4. **Privacy first** - プライバシーは基本。金融データを扱う上での絶対条件
...
世界トップレベルのモダンな設計。アクセシビリティを核に据える。
...
- `@faro/infrastructure` - `@faro/core`のみに依存
...
1. **将来の拡張性を優先** - 現在の設計にこだわらない
2. **品質に妥協しない** - 常に世界クラスの基準を目指す
3. **技術にとらわれない** - より良い解決策があれば躊躇なく採用
4. **Clean Architecture** - ビジネスロジックをインフラから分離
5. **モバイルファースト思考** - 最初からマルチプラットフォームを設計
