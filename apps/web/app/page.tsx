...
import { useChatStore } from '../components/features/chat/stores/chatStore'
import { useGuestNotesStore } from '../components/features/notes/stores/guestNotesStore'
import { useAppStore } from '../lib/store/useAppStore'
import { motion, AnimatePresence } from 'framer-motion'
import { UsageIndicator } from '../components/features/subscription/components/UsageIndicator'
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-800">
                  {isGuest ? (
                    <button
                      ...
                      className="w-full py-2.5 px-4 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 rounded-xl flex items-center justify-center space-x-2 transition-all"
                    >
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">Googleでログイン</span>
                    </button>
                  ) : (
                    <div className="space-y-2">
                      ...
                      <button
                        onClick={signOut}
                        className="w-full py-1.5 px-3 text-xs text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
                      >
                        ログアウト
                      </button>
                    </div>
