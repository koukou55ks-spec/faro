...
import { NotesApp } from '@/components/workspace/NotesApp'
import { KakeiboApp } from '@/components/workspace/KakeiboApp'
            ...
            {!activeWorkspaceApp ? (
              ...
              <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-hidden">
                  {activeWorkspaceApp === 'notes' && <NotesApp />}
                  {activeWorkspaceApp === 'kakeibo' && <KakeiboApp />}
                </div>
              </div>
            )}
          </motion.div>
